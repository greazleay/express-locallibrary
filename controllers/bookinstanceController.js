...
exports.bookinstance_update_get = (req, res, next) => {
    BookInstance.findById(req.params.id).populate('book').exec((err, bookinstance) => {
        ...
        res.render('bookinstance_updateform', { title: 'Update Book Instance', bookinstance: bookinstance })
    })
};
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            BookInstance.findById(req.params.id).populate('book').exec((err, bookinstance) => {
                ...
                res.render('bookinstance_updateform', { title: 'Update Book Instance', bookinstance: bookinstance, errors: errors.array() })
            })
        } else {
            // Data from form is valid
